...
json.plants @user.plants.each do |plant|
 ...
 if plant.plant_chat.present? && plant.plant_chat.messages.present?
  (json.plant_thirsty plant.plant_chat.messages.last.text == "Coucou.....Time to water your baby .......!") || (json.plant_thirsty plant.plant_chat.messages.last.text == "ok..dear leader.. somebody's a busy bee. Just make sure to water me later - I'm thirsty!")
  else
